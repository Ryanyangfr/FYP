...
export default {
    ...
    methods: {
        ...
        toggleGenerate(){
            ...
            axios.post('http://54.251.178.255:3000/trail/initializeTrail', postBody)
            .then(response => {
        ...
        startTrail(){
            ...
            axios.post('http://54.251.178.255:3000/trail/startTrail', postBody)
            .then(response => {
                let data = response.data;
                console.log(data);
            })
    ...
    mounted(){
        ...
        axios.get('http://54.251.178.255/trail/getAllTrails')
        .then(response => {
            let data = response.data;
            for(var row in data){
