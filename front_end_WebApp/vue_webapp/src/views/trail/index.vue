...
export default {
    ...
    methods : {
        ...
        fetchMissions(missionList, missionType){
            ...
            // console.log(hotspot)
            axios.get('//127.0.0.1:3000/mission/getMission' + missionType)
            .then(response =>{
        ...
        axios.post('//127.0.0.1:3000/trail/addTrail', postBody)
        .then(response => {
        ...
        this.currHotspotsAndMissions.forEach((hotspotAndMission) => {
            ...
            console.log(postBody);
            axios.post('//127.0.0.1:3000/trail/editTrail', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                // this.$router.go();
        ...
        onSubmitToDeleteTrail(){
            ...
            axios.post('//127.0.0.1:3000/trail/deleteTrail', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
    ...
    axios.get('//127.0.0.1:3000/narrative/getNarratives')
    .then(response => {
        let data = response.data;
        for(var row in data){
            console.log(data[row])
