...
export default {
    ...
    methods: {
        getData() {
            const baseURI = '//127.0.0.1:3000/team/getAllTeamPoints?trail_instance_id=' + this.trail_instance_id;
            axios.get(baseURI)
            .then(response => {
        ...
        onSubmitToEdit(){
            ...
            axios.post('//127.0.0.1:3000/team/updateScoreAdmin', postBody)
            .then(response => {
        ...
        calcEndTime(item) {
            ...
            axios.post('//127.0.0.1:3000/team/updateTeamEndTime', postBody)
            .then(response => {
                console.log(response);
            });
    ...
    mounted(){
        ...
        axios.get('//127.0.0.1:3000/team/activityFeed')
        .then(response => {
            let data = response.data;
            for(var row in data){
                console.log(data[row])
    ...
    // ]
        ...
        const baseURI = '//127.0.0.1:3000/team/getAllTeamPoints';
        axios.get(baseURI)
        .then(response => {
            console.log(response);
            this.items = response.data;
