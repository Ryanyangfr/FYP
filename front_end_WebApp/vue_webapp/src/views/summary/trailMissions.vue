...
export default {
    ...
    methods: {
        ...
        fetchMissions(){
            // console.log('entered')
            this.missionList = [];
            axios.get('//13.229.115.32:3000/mission/getMissionQuizHistory')
            .then(response =>{
        ...
        getMissionQuizQuestions(missionid, mission){
            axios.get('//13.229.115.32:3000/quiz/getQuizQuestionHistory?mission=' + missionid)
                .then(response =>{
    ...
    mounted(){
        ...
        axios.get('//13.229.115.32:3000/upload/getSubmissionQuestionHistory?trailInstanceID=' + this.trailID)
        .then(response => {
        ...
        axios.get('//13.229.115.32:3000/mission/getMissionQuizHistory?trailInstanceID=' + this.trailID)
        .then(response =>{
            let data = response.data;
            // console.log(data);
            for(var index in data){
        ...
        axios.get('//13.229.115.32:3000/draganddrop/getDragAndDropHistory?trailInstanceID=' + this.trailID)
        .then(response =>{
            let data = response.data;
            console.log(data);
        ...
        axios.get('//13.229.115.32:3000/upload/getDrawingQuestionHistory?trailInstanceID=' + this.trailID)
        .then(response => {
            let data = response.data;
            for(var row in data){
                console.log(data[row])
        ...
        axios.get('//13.229.115.32:3000/anagram/getAnagramsHistory?trailInstanceID=' + this.trailID)
        .then(response => {
            let data = response.data;
            for(var row in data){
                console.log(data[row])
        ...
        axios.get('//13.229.115.32:3000/wordsearch/getWordSearchWordsHistory?trailInstanceID=' + this.trailID)
        .then(response => {
            let data = response.data;
             let wordsearchWords = []
            for(var row in data){
