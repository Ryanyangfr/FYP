...
export default {
    ...
    methods: {
        ...
        quizOnSubmitToAdd(){
            ...
            console.log(this.quiz);
            axios.post('//127.0.0.1:3000/add/addQuiz', postBody)
            .then(response => {
        ...
        wefieOnSubmitToAdd(){
            ...
            console.log(this.title);
            axios.post('//127.0.0.1:3000/add/addWefieQuestion', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                this.$router.push({ path: this.redirect || '/mission' })
        ...
        dragAndDropOnSubmitToAdd(){
            ...
            axios.post('//127.0.0.1:3000/add/addDragAndDropQuestion', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                this.$router.push({ path: this.redirect || '/mission' });
        ...
        drawingOnSubmitToAdd(){
            ...
            console.log(this.title);
            axios.post('//127.0.0.1:3000/add/addDrawingQuestion', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                this.$router.push({ path: this.redirect || '/mission' })
        ...
        anagramOnSubmitToAdd(){
            ...
            axios.post('//127.0.0.1:3000/add/addAnagram', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                this.$router.push({ path: this.redirect || '/mission' })
        ...
        wordsearchOnSubmitToAdd(){
            ...
            axios.post('//127.0.0.1:3000/add/addWordsearchQuestion', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                this.$router.push({ path: this.redirect || '/mission' })
