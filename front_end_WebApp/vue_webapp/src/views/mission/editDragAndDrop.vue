...
export default {
    ...
    methods: {
      dragAndDropOnSubmitToEdit(){
        ...
        axios.post('http://13.229.115.32:3000/edit/editDragAndDrop', postBody)
        .then(response => {
    ...
    mounted(){
      ...
      axios.get('http://13.229.115.32:3000/draganddrop/getDragAndDropByMission?missionID=' + this.draganddrop_missionID)
      .then(response =>{
