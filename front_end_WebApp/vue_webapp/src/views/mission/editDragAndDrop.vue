...
export default {
    ...
    methods: {
      dragAndDropOnSubmitToEdit(){
        ...
        axios.post('http://54.255.245.23:3000/edit/editDragAndDrop', postBody)
        .then(response => {
    ...
    mounted(){
      ...
      axios.get('http://54.255.245.23:3000/draganddrop/getDragAndDropByMission?missionID=' + this.draganddrop_missionID)
      .then(response =>{
