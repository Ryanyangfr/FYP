...
export default {
    ...
    methods: {
      dragAndDropOnSubmitToEdit(){
        ...
        axios.post('//13.228.173.165:3000/edit/editDragAndDrop', postBody)
        .then(response => {
    ...
    mounted(){
      ...
      axios.get('//13.228.173.165:3000/draganddrop/getDragAndDropByMission?missionID=' + this.draganddrop_missionID)
      .then(response =>{
