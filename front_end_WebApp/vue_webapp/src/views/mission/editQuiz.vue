...
export default {
    ...
    methods:{
        ...
        getQuizOptions(quiz_question, quiz_id, quiz_answer) {
             axios.get('//127.0.0.1:3000/quiz/getQuizOptions?quizID=' + quiz_id)
            .then(response =>{
        ...
        quizOnSubmitToEdit() {
            ...
            // console.log(this.quiz);
            axios.post('//127.0.0.1:3000/edit/editQuiz', postBody)
            .then(response => {
    ...
    mounted(){
        ...
        axios.get('//127.0.0.1:3000/quiz/getQuizQuestion?mission=' + this.$store.state.selectedQuizID)
        .then(response =>{
            var data = response.data;
            console.log(data)
