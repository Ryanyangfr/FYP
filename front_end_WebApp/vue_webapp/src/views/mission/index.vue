...
export default {
    ...
    methods: {
        ...
        fetchMissions(){
            // console.log('entered')
            this.missionList = [];
            axios.get('//127.0.0.1:3000/mission/getMissionQuiz')
            .then(response =>{
        ...
        getMissionQuizQuestions(missionid, mission){
            axios.get('//127.0.0.1:3000/quiz/getQuizQuestion?mission=' + missionid)
                .then(response =>{
        ...
        onSubmitToDeleteQuiz(){
            ...
            axios.post('//127.0.0.1:3000/delete/deleteQuiz', postBody)
            .then(response => {
        ...
        onSubmitToDeleteWefie(){
            ...
            axios.post('//127.0.0.1:3000/delete/deleteWefieQuestion', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                if (data.success === "true") {
        ...
        onSubmitToDeleteDragDrop(){
            ...
            axios.post('//127.0.0.1:3000/delete/deleteDragAndDrop', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                if (data.success === "true") {
        ...
        onSubmitToDeleteAnagram(){
            ...
            axios.post('//127.0.0.1:3000/delete/deleteAnagram', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                if (data.success === "true") {
        ...
        onSubmitToDeleteDrawing(){
            ...
            axios.post('//127.0.0.1:3000/delete/deleteDrawingQuestion', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                if (data.success === "true") {
        ...
        onSubmitToDeleteWordsearch(){
            ...
            console.log(postBody)
            axios.post('//127.0.0.1:3000/delete/deleteWordsearch', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                if (data.success === "true") {
    ...
    mounted(){
        ...
        // axios.get('//127.0.0.1:3000/hotspot/getHotspots')
        // .then(response => {
        //     let data = response.data;
        //     for(var row in data){
        ...
        axios.get('//127.0.0.1:3000/upload/getAllSubmissionQuestion')
        .then(response => {
            let data = response.data;
            for(var row in data){
                console.log(data[row])
        ...
        axios.get('//127.0.0.1:3000/draganddrop/getAllDragAndDrop')
        .then(response =>{
            let data = response.data;
            console.log(data);
        ...
        axios.get('//127.0.0.1:3000/upload/getAllDrawingQuestion')
        .then(response => {
            let data = response.data;
            for(var row in data){
                console.log(data[row])
        ...
        axios.get('//127.0.0.1:3000/anagram/getAllAnagrams')
        .then(response => {
            let data = response.data;
            for(var row in data){
                console.log(data[row])
        ...
        axios.get('//127.0.0.1:3000/wordsearch/getAllWordSearchWords')
        .then(response => {
            let data = response.data;
             let wordsearchWords = []
            for(var row in data){
