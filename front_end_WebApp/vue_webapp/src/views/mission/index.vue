...
export default {
    ...
    methods: {
        ...
        onSubmitToDeleteDragDrop(){
            ...
            axios.post('http://13.229.115.32:3000/delete/deleteDragAndDrop', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                if (data.success === "true") {
        ...
        onSubmitToDeleteDrawing(){
            ...
            axios.post('http://13.229.115.32:3000/delete/deleteDrawingQuestion', postBody)
            .then(response => {
                let data = response.data
                console.log(data)
                if (data.success === "true") {
    ...
    mounted(){
        ...
        axios.get('http://13.229.115.32:3000/draganddrop/getAllDragAndDrop')
        .then(response =>{
            let data = response.data;
            console.log(data);
        ...
        axios.get('http://13.229.115.32:3000/upload/getAllDrawingQuestion')
        .then(response => {
            let data = response.data;
            for(var row in data){
                console.log(data[row])
