...
export default {
  ...
  methods : {
    ...
    switchTeam(){
        ...
        axios.post('http://13.229.115.32:3000/edit/switchTeams', postBody)
        .then(response => {
    ...
    deleteParticipant(){
        ...
        axios.post('http://13.229.115.32:3000/delete/deleteParticipant', postBody)
        .then(response => {
            let data = response.data;
            console.log(data);
            this.$router.go();
  ...
  mounted() {
    axios.get('http://13.229.115.32:3000/team/getAllTeamsWithMembers')
        .then(response => {
            let data = response.data;
            console.log(data);
