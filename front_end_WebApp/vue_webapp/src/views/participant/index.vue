...
export default {
  ...
  methods : {
    ...
    switchTeam(){
        ...
        axios.post('//127.0.0.1:3000/edit/switchTeams', postBody)
        .then(response => {
    ...
    deleteParticipant(){
        ...
        axios.post('//127.0.0.1:3000/delete/deleteParticipant', postBody)
        .then(response => {
            let data = response.data;
            console.log(data);
            this.$router.go();
  ...
  mounted() {
    axios.get('//127.0.0.1:3000/team/getAllTeamsWithMembers')
        .then(response => {
            let data = response.data;
            console.log(data);
