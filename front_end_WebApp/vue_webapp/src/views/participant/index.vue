...
export default {
  ...
  methods : {
    ...
    switchTeam(){
        ...
        axios.post('//54.255.245.23:3000/edit/switchTeams', postBody)
        .then(response => {
    ...
    deleteParticipant(){
        ...
        axios.post('//54.255.245.23:3000/delete/deleteParticipant', postBody)
        .then(response => {
            let data = response.data;
            console.log(data);
            this.$router.go();
  ...
  mounted() {
    axios.get('//54.255.245.23:3000/team/getAllTeamsWithMembers')
        .then(response => {
            let data = response.data;
            console.log(data);
