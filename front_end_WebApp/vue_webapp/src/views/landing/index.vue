...
<style>
   .card{
    ...
    .Landing table tr:nth-child(1) {
        border-top: 1px solid #DEE2E6;
        /* background-color: pink */
    }

    .trail-creation-title, .location-creation-title, .narrative-creation-title{
        font-weight: 600;
        font-size: 19px
    }
