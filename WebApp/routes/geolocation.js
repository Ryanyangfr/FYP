...
router.get('/getAllHotspots', function(req,res){
    ...
    var query = 'SELECT HOTSPOT.HOTSPOT_NAME, LATITUDE, LONGTITUDE FROM TRAIL_HOTSPOT, HOTSPOT WHERE TRAIL_ID = (SELECT TRAIL_ID FROM TRAIL_INSTANCE WHERE TRAIL_INSTANCE_ID = ?) AND TRAIL_HOTSPOT.HOTSPOT_NAME = HOTSPOT.HOTSPOT_NAME';
