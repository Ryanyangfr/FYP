...
TEAM_ID INT NOT NULL,
TRAIL_INSTANCE_ID VARCHAR(10),
isLeader TINYINT NOT NULL,
CONSTRAINT PARTICIPANT_PK PRIMARY KEY (USER_ID,TRAIL_INSTANCE_ID),
CONSTRAINT PARTICIPANT_FK1 FOREIGN KEY (TEAM_ID)
REFERENCES TEAM(TEAM_ID),
CONSTRAINT PARTICIPANT_FK2 FOREIGN KEY (TRAIL_INSTANCE_ID)
REFERENCES TRAIL_INSTANCE(TRAIL_INSTANCE_ID)
);
...
CONSTRAINT TEAM_HOTSPOT_STATUS_FK1 FOREIGN KEY (TRAIL_INSTANCE_ID)
REFERENCES TEAM(TRAIL_INSTANCE_ID),
CONSTRAINT TEAM_HOTSPOT_STATUS_FK2 FOREIGN KEY (TEAM_ID)
REFERENCES TEAM(TEAM_ID)
);
...
(
WORDSEARCH_ID INT NOT NULL,
MISSION_ID INT NOT NULL,
CONSTRAINT WORDSEARCH_PK PRIMARY KEY (WORDSEARCH_ID),
...
CONSTRAINT WORDSEARCH_WORD_PK PRIMARY KEY (WORDSEARCH_ID,WORD),
CONSTRAINT WORDSEARCH_WORD_FK1 FOREIGN KEY (WORDSEARCH_ID)
REFERENCES WORDSEARCH(WORDSEARCH_ID)
);
...
HOTSPOT_NAME VARCHAR(50) NOT NULL,
MISSION_ID INT NOT NULL,
CONSTRAINT SUMMARY_TABLE_PK PRIMARY KEY(SUMMARY_ID)
);

CREATE TABLE DRAG_AND_DROP_HISTORY
(
DRAGANDDROP_ID INT NOT NULL,
DRAGANDDROP_QUESTION VARCHAR(1000) NOT NULL,
MISSION_ID INT NOT NULL,
CONSTRAINT DRAGANDDROP_HISTORY_PK PRIMARY KEY (DRAGANDDROP_ID),
CONSTRAINT DRAGANDDROP_HISTORY_FK1 FOREIGN KEY (MISSION_ID)
REFERENCES MISSION_HISTORY(MISSION_ID)
);

CREATE TABLE DRAG_AND_DROP_OPTION_HISTORY
(
DRAGANDDROP_ID INT NOT NULL,
DRAGANDDROP_QUESTION_OPTION VARCHAR(500) NOT NULL,
DRAGANDDROP_QUESTION_ANSWER VARCHAR(500) NOT NULL,
CONSTRAINT DRAG_AND_DROP_HISTORY_OPTION_PK PRIMARY KEY (DRAGANDDROP_ID,DRAGANDDROP_QUESTION_OPTION, DRAGANDDROP_QUESTION_ANSWER),
CONSTRAINT DRAG_AND_DROP_HISTORY_OPTION_FK1 FOREIGN KEY (DRAGANDDROP_ID)
REFERENCES DRAG_AND_DROP_HISTORY(DRAGANDDROP_ID)
);

CREATE TABLE ANAGRAM_HISTORY
(
ANAGRAM_ID INT NOT NULL,
ANAGRAM_WORD VARCHAR(1000) NOT NULL,
MISSION_ID INT NOT NULL,
CONSTRAINT ANAGRAM_HISTORY_PK PRIMARY KEY (ANAGRAM_ID),
CONSTRAINT ANAGRAM_HISTORY_FK1 FOREIGN KEY (MISSION_ID)
REFERENCES MISSION_HISTORY(MISSION_ID)
);

CREATE TABLE WORDSEARCH_HISTORY
(
WORDSEARCH_ID INT NOT NULL,
MISSION_ID INT NOT NULL,
CONSTRAINT WORDSEARCH_HISTORY_PK PRIMARY KEY (WORDSEARCH_ID),
CONSTRAINT WORDSEARCH_HISTORY_FK1 FOREIGN KEY (MISSION_ID)
REFERENCES MISSION_HISTORY(MISSION_ID)
);

CREATE TABLE WORDSEARCH_WORD_HISTORY
(
WORDSEARCH_ID INT NOT NULL,
WORD VARCHAR(100) NOT NULL,
CONSTRAINT WORDSEARCH_WORD_HISTORY_PK PRIMARY KEY (WORDSEARCH_ID,WORD),
CONSTRAINT WORDSEARCH_WORD_HISTORY_FK1 FOREIGN KEY (WORDSEARCH_ID)
REFERENCES WORDSEARCH_HISTORY(WORDSEARCH_ID)
);
...
QUIZ_ANSWER VARCHAR(1000) NOT NULL,
MISSION_ID INT NOT NULL,
CONSTRAINT QUIZ_HISTORY_PK PRIMARY KEY (QUIZ_ID),
CONSTRAINT QUIZ_HISTORY_FK1 FOREIGN KEY (MISSION_ID)
REFERENCES MISSION_HISTORY(MISSION_ID)
);

CREATE TABLE QUIZ_OPTION_HISTORY
(
QUIZ_ID INT NOT NULL,
QUIZ_OPTION_ID INT NOT NULL,
QUIZ_OPTION VARCHAR(1000) NOT NULL,
CONSTRAINT QUIZ_OPTION_HISTORY_PK PRIMARY KEY (QUIZ_ID, QUIZ_OPTION_ID),
CONSTRAINT QUIZ_OPTION_HISTORY_FK1 FOREIGN KEY (QUIZ_ID)
REFERENCES QUIZ_HISTORY(QUIZ_ID)
);

CREATE TABLE SUBMISSION_QUESTION_HISTORY
(
QUESTION_ID INT NOT NULL,
QUESTION VARCHAR(1000) NOT NULL,
MISSION_ID INT NOT NULL,
CONSTRAINT SUBMISSION_QUESTION_HISTORY_PK PRIMARY KEY (QUESTION_ID),
CONSTRAINT SUBMISSION_QUESTION_HISTORY_FK FOREIGN KEY (MISSION_ID)
REFERENCES MISSION_HISTORY(MISSION_ID)
);

CREATE TABLE DRAWING_QUESTION_HISTORY
(
QUESTION_ID INT NOT NULL,
QUESTION VARCHAR(1000) NOT NULL,
MISSION_ID INT NOT NULL,
CONSTRAINT DRAWING_QUESTION_HISTORY_PK PRIMARY KEY (QUESTION_ID),
CONSTRAINT DRAWING_QUESTION_HISTORY_FK FOREIGN KEY (MISSION_ID)
REFERENCES MISSION_HISTORY(MISSION_ID)
);

INSERT INTO NARRATIVE VALUES
(1, 'LKCSB NARRATIVE','In 2000, SMU commenced its curriculum with the School of Business, welcoming its first batch of cohort in August. The SMU School of Business and university-wide scholars programme was named in perpetuity after Dr Lee Kong Chian in recognition of the Lee Foundation generous contribution of S$50 million to SMU in 2004. Dr Lee Kong Chain is a well-known Southeast Asia businessman, philanthropist and community leader. SMU school of business is therefore known as LKCSB (Lee Kong Chian School of Business)'),
