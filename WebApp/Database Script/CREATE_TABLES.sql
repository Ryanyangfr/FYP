...
CREATE TABLE DRAGANDDROP_OPTION
(
DRAGANDDROP_ID INT NOT NULL,
DRAGANDDROP_QUESTION_OPTION VARCHAR(1000) NOT NULL,
DRAGANDDROP_QUESTION_ANSWER VARCHAR(1000) NOT NULL,
CONSTRAINT DRAG_AND_DROP_OPTIONS_PK PRIMARY KEY (DRAGANDDROP_ID,DRAGANDDROP_QUESTION_OPTION),
CONSTRAINT DRAG_AND_DROP_OPTIONS_FK1 FOREIGN KEY (DRAGANDDROP_ID)
